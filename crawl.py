...
def get_email(url, site_title):
    # Registers an email address with the mail API, and returns the email address
...
def crawl_site(site, manager, email_producer):
    ...
    command_sequence.fill_forms(email_producer=email_producer, num_links=3, timeout=120, page_timeout=8, debug=False)
